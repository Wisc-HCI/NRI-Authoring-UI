  ...
  (function webpackUniversalModuleDefinition(root, factory) {
    ...
    return (function(modules) {
      ...
      function DownloadText(FileSaver, Blob, $timeout) {
        var vm = this;
        vm.val = {text: 'Hey ho lets go!'};
        vm.download = function(text) {
          var data = new Blob([text], {type: 'text/plain;charset=utf-8'});
          $timeout(FileSaver.saveAs.bind(FileSaver, data, 'text.txt'), 100);
        };
      }
      angular.module('fileSaverExample', ['ngFileSaver']).controller('DownloadText', ['FileSaver', 'Blob', '$timeout', DownloadText]);
    }, function(module, exports, __webpack_require__) {
      ...
      angular.module('ngFileSaver', []).factory('FileSaver', ['Blob', 'SaveAs', 'FileSaverUtils', __webpack_require__(4)]).factory('FileSaverUtils', [__webpack_require__(5)]).factory('Blob', ['$window', __webpack_require__(6)]).factory('SaveAs', [__webpack_require__(8)]);
    }, function(module, exports) {
      'use strict';
      module.exports = function FileSaver(Blob, SaveAs, FileSaverUtils) {
        ...
        return {saveAs: function(data, filename, disableAutoBOM) {
      ...
      module.exports = function SaveAs() {
        return __webpack_require__(9).saveAs || function() {};
      };
    }, function(module, exports, __webpack_require__) {
